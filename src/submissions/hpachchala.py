...
print('Harry Pachchala, Sophomore, Data Science')
print('I bake and Ive lived in 3 countries')
print('I would like to learn the practical applications of computer science')
