...
print('Kobi Bell, Junior Computer Science')
print('I like to partake in combat sports, gaming, and listening to music.')
print('I would like to work on the inter-communication of Junebug / Scion.')