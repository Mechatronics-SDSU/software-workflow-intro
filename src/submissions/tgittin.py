...
print('Talor Gittin, High School Freshman, N/A')
print('I like to do web design (full-stack)/making websites. I am a summer intern at the csl structural biochemisty department')
print('I would like to learn more about MCUs and robotics. I would also like to learn about A.I, mainly image recognition')
