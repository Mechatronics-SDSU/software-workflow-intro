...
: ${AMENT_CURRENT_PREFIX:="/home/bigman/repos/software-workflow-intro/IntroWorkSpaceHectorAnaya/src/install/epoch_publisher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/epoch_publisher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/epoch_publisher/environment/path.sh"
