...
print('Juyeon Kim', 'Junior', 'Computer Science')
print('I like riding a bicycle, listening to music, hanging out with friends and eating delicious food.')
print('I want to be familiar with using a Python.')
