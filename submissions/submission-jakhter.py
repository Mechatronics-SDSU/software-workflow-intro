...
print('Jibran Akhter, Sophomore, Computer Engineering')
print('I like cycling on high inclined planes and I love playing fortnite.')
print('I would like to learn more about python programming language.')
