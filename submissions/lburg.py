...
print('Lionel Burg, 3rd year, Computer Science')
print('I like playing and watching soccer and I am an exchange student from Germany.')
print('I would like work with like minded people on an interesting project.')
