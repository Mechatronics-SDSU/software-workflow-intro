...
print('Thomas Trinh, Third Year, Computer Engineering')
print('I like running, 3D printing, and designing mechanical keyboards')
print('I want to gain more hands-on experience with programming and learn about control systems')
