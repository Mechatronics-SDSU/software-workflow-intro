...
print('Connor Larmer, Junior (in highschool), Undeclared')
print('I like playing guitar and always avoid sleep when I can.')
print('I hope to become more proficient at programming (and help with a neat robot too).')
