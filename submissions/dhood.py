...
print('Devon Hood, Senior, Computer Science')
print('I like to regularly go solo backpacking for a week or so.  I also like to climb.')
print('Practical application and learning some cool robot stuff.')
