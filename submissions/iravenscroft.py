...
print('Ian Ravenscroft, Sophomore, Applied Math')
print('I like Busch Light and my favorite thing to do is go tubing whilst drinking Busch Light.')
print('I would like to learn how to develop software for automated machinery.')
