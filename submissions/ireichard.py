...
print('Ian Reichard, Senior, Computer Science')
print('I play Tabletop RPGs and I love playing Factorio.')
print('I would like to build the best software we\'ve ever had for a robot.')
