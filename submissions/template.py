...
print('Lucio beltran, Junior, Computer Science')
print('I enoy playing games, specially fighting games.')
print('My goal for mechatronics is to work alongside everone else and get Junebug going.')
