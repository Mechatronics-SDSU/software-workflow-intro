...
print('Anthony Norderhaug, Junior, Computer Science')
print('I like filming and editing videos and I love Quest protein bars.')
print('I would like to learn how to program computer vision.')
