...
package2__msg__Time__create()
{
  ...
  package2__msg__Time * msg = (package2__msg__Time *)allocator.allocate(sizeof(package2__msg__Time), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(package2__msg__Time));
  bool success = package2__msg__Time__init(msg);
  if (!success) {
...
package2__msg__Time__Sequence__init(package2__msg__Time__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  package2__msg__Time * data = NULL;

  if (size) {
    data = (package2__msg__Time *)allocator.zero_allocate(size, sizeof(package2__msg__Time), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = package2__msg__Time__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        package2__msg__Time__fini(&data[i - 1]);
      }
...
package2__msg__Time__Sequence__fini(package2__msg__Time__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      package2__msg__Time__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  package2__msg__Time__Sequence * array = (package2__msg__Time__Sequence *)allocator.allocate(sizeof(package2__msg__Time__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = package2__msg__Time__Sequence__init(array, size);
  if (!success) {
...
package2__msg__Time__Sequence__destroy(package2__msg__Time__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    package2__msg__Time__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
package2__msg__Time__Sequence__are_equal(const package2__msg__Time__Sequence * lhs, const package2__msg__Time__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!package2__msg__Time__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  package2__msg__Time__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(package2__msg__Time);
    package2__msg__Time * data =
      (package2__msg__Time *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!package2__msg__Time__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          package2__msg__Time__fini(&data[i]);
        }
        free(data);
        return false;
      }
