...
#include "package2/msg/detail/time__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const package2::msg::Time *>(
    untyped_ros_message);
...
{
  return &package2::msg::typesupport_fastrtps_cpp::_Time__handle;
}
