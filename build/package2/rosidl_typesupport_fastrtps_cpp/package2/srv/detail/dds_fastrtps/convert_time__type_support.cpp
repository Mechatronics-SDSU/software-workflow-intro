...
#include "package2/srv/detail/convert_time__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const package2::srv::ConvertTime_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<package2::srv::ConvertTime_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_package2
const rosidl_message_type_support_t *
get_message_type_support_handle<package2::srv::ConvertTime_Request>()
{
  return &package2::srv::typesupport_fastrtps_cpp::_ConvertTime_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const package2::srv::ConvertTime_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<package2::srv::ConvertTime_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &package2::srv::typesupport_fastrtps_cpp::_ConvertTime_Response__handle;
}
...
{
  return &package2::srv::typesupport_fastrtps_cpp::_ConvertTime__handle;
}
