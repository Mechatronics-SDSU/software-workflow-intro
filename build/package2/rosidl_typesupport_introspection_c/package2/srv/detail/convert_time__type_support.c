...
#include <stddef.h>
#include "package2/srv/detail/convert_time__rosidl_typesupport_introspection_c.h"
#include "package2/msg/rosidl_typesupport_introspection_c__visibility_control.h"
...
static rosidl_typesupport_introspection_c__MessageMember ConvertTime_Request__rosidl_typesupport_introspection_c__ConvertTime_Request_message_member_array[1] = {
  {
    ...
    offsetof(package2__srv__ConvertTime_Request, unixtime),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers ConvertTime_Request__rosidl_typesupport_introspection_c__ConvertTime_Request_message_members = {
  "package2__srv",  // message namespace
  "ConvertTime_Request",  // message name
  1,  // number of fields
  sizeof(package2__srv__ConvertTime_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_package2
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package2, srv, ConvertTime_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember ConvertTime_Response__rosidl_typesupport_introspection_c__ConvertTime_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(package2__srv__ConvertTime_Response, humantime),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ConvertTime_Response__rosidl_typesupport_introspection_c__ConvertTime_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(package2__srv__ConvertTime_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_package2
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package2, srv, ConvertTime_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_service_members = {
  "package2__srv",  // service namespace
  "ConvertTime",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_Request_message_type_support_handle,
  NULL  // response message
  // package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_Response_message_type_support_handle
};

static rosidl_service_type_support_t package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_service_type_support_handle = {
  0,
  &package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package2, srv, ConvertTime)() {
  if (!package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_service_type_support_handle.typesupport_identifier) {
    package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package2, srv, ConvertTime_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package2, srv, ConvertTime_Response)()->data;
  }

  return &package2__srv__detail__convert_time__rosidl_typesupport_introspection_c__ConvertTime_service_type_support_handle;
}
