...
#include "package1/srv/detail/convert_time__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const package1::srv::ConvertTime_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<package1::srv::ConvertTime_Request *>(
    untyped_ros_message);
...
{
  return &package1::srv::typesupport_fastrtps_cpp::_ConvertTime_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const package1::srv::ConvertTime_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<package1::srv::ConvertTime_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &package1::srv::typesupport_fastrtps_cpp::_ConvertTime_Response__handle;
}
...
{
  return &package1::srv::typesupport_fastrtps_cpp::_ConvertTime__handle;
}
