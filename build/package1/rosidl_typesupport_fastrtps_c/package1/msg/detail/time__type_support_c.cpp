...
#include "package1/msg/detail/time__rosidl_typesupport_fastrtps_c.h"
...
using _Time__ros_msg_type = package1__msg__Time;
...
static uint32_t _Time__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_package1__msg__Time(
...
{
  return max_serialized_size_package1__msg__Time(
    full_bounded, 0);
}
