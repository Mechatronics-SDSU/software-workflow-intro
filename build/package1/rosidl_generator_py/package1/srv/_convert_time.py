...
class Metaclass_ConvertTime_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('package1')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ConvertTime(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from package1.srv import _convert_time
...
class ConvertTime(metaclass=Metaclass_ConvertTime):
    from package1.srv._convert_time import ConvertTime_Request as Request
    from package1.srv._convert_time import ConvertTime_Response as Response
