...
#include "time_types/srv/detail/convert_time__rosidl_typesupport_fastrtps_c.h"
...
#include "time_types/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ConvertTime_Request__ros_msg_type = time_types__srv__ConvertTime_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_time_types
size_t get_serialized_size_time_types__srv__ConvertTime_Request(
  const void * untyped_ros_message,
...
static uint32_t _ConvertTime_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_time_types__srv__ConvertTime_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_time_types
size_t max_serialized_size_time_types__srv__ConvertTime_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_time_types__srv__ConvertTime_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, time_types, srv, ConvertTime_Request)() {
...
using _ConvertTime_Response__ros_msg_type = time_types__srv__ConvertTime_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_time_types
size_t get_serialized_size_time_types__srv__ConvertTime_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ConvertTime_Response__ros_msg_type * ros_message = static_cast<const _ConvertTime_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_time_types__srv__ConvertTime_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_time_types
size_t max_serialized_size_time_types__srv__ConvertTime_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_time_types__srv__ConvertTime_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, time_types, srv, ConvertTime_Response)() {
...
// already included above
// #include "time_types/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "time_types/srv/convert_time.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, time_types, srv, ConvertTime)() {
