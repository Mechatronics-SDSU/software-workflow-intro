...
#include "time_types/msg/detail/time__rosidl_typesupport_fastrtps_c.h"
...
using _Time__ros_msg_type = time_types__msg__Time;
...
size_t get_serialized_size_time_types__msg__Time(
  const void * untyped_ros_message,
...
static uint32_t _Time__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_time_types__msg__Time(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_time_types
size_t max_serialized_size_time_types__msg__Time(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_time_types__msg__Time(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, time_types, msg, Time)() {
