...
#ifndef TIME_TYPES__SRV__DETAIL__CONVERT_TIME__FUNCTIONS_H_
#define TIME_TYPES__SRV__DETAIL__CONVERT_TIME__FUNCTIONS_H_
 ...
 * calls
 * time_types__srv__ConvertTime_Request__init().
...
/**
 * It calls
 * time_types__srv__ConvertTime_Request__fini()
 ...
 * time_types__srv__ConvertTime_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * time_types__srv__ConvertTime_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * time_types__srv__ConvertTime_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_time_types
...
/**
 * It calls
 * time_types__srv__ConvertTime_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_time_types
...
/**
 * It allocates the memory for the array and calls
 * time_types__srv__ConvertTime_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_time_types
...
/**
 * It calls
 * time_types__srv__ConvertTime_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIME_TYPES__SRV__DETAIL__CONVERT_TIME__FUNCTIONS_H_
