...
class Metaclass_ConvertTime_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('time_types')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ConvertTime(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from time_types.srv import _convert_time
...
class ConvertTime(metaclass=Metaclass_ConvertTime):
    from time_types.srv._convert_time import ConvertTime_Request as Request
    from time_types.srv._convert_time import ConvertTime_Response as Response
