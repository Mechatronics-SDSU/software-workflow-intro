...
#include <stddef.h>
#include "time_types/msg/detail/time__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Time__rosidl_typesupport_introspection_c__Time_message_member_array[1] = {
  {
    ...
    offsetof(time_types__msg__Time, time),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Time__rosidl_typesupport_introspection_c__Time_message_members = {
  "time_types__msg",  // message namespace
  "Time",  // message name
  1,  // number of fields
  sizeof(time_types__msg__Time),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, time_types, msg, Time)() {
