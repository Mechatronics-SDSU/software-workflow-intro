...
#include <stddef.h>
#include "package2/msg/detail/time__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Time__rosidl_typesupport_introspection_c__Time_message_member_array[1] = {
  {
    ...
    offsetof(package2__msg__Time, time),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Time__rosidl_typesupport_introspection_c__Time_message_members = {
  "package2__msg",  // message namespace
  "Time",  // message name
  1,  // number of fields
  sizeof(package2__msg__Time),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package2, msg, Time)() {
