...
{
  new (message_memory) package2::msg::Time(_init);
}

void Time_fini_function(void * message_memory)
{
  auto typed_message = static_cast<package2::msg::Time *>(message_memory);
  typed_message->~Time();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Time_message_member_array[1] = {
  {
    ...
    offsetof(package2::msg::Time, time),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Time_message_members = {
  "package2::msg",  // message namespace
  "Time",  // message name
  1,  // number of fields
  sizeof(package2::msg::Time),
...
{
  return &::package2::msg::rosidl_typesupport_introspection_cpp::Time_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, package2, msg, Time)() {
  return &::package2::msg::rosidl_typesupport_introspection_cpp::Time_message_type_support_handle;
}
